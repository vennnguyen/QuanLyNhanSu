	...
	public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                departmentForm1 ungVienView = new departmentForm1();
				//set thử dữ liệu
				Object[][] sampleData = {
					{1, "Phòng IT", "2010-01-01", "Nguyễn Văn A", "2015-06-01", 20, "15 triệu"},
					{2, "Phòng Kế toán", "2012-03-10", "Trần Thị B", "2016-07-15", 10, "12 triệu"}
				};
				ungVienView.setDepartmentData(sampleData);
				//
